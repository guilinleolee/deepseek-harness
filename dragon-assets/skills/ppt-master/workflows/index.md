...
| `md-to-pptx` | [`md-to-pptx.md`](./md-to-pptx.md) | Quick Markdown to PPTX conversion | Markdown file exists | Not for complex designs | Standalone | PPTX file | Stops on parse errors |
| `content-optimize` | [`content-optimize.md`](./content-optimize.md) | Optimize existing PPTX content with AI | Source PPTX exists | Not for new PPTX generation | After import | Optimized content outline | Stops on no content detected |
| `import-template` | [`import-template.md`](./import-template.md) | Import external PPTX/PDF as template | External file exists | Not for content conversion | Standalone | Template in library | Stops on invalid file |
| `chart-generation` | [`chart-generation.md`](./chart-generation.md) | Generate charts from natural language | Data description provided | Not for manual chart creation | Standalone | SVG chart file | Stops on parse errors |
| `team-collaboration` | [`team-collaboration.md`](./team-collaboration.md) | Share templates with team members | Team context exists | Not for public templates | Standalone | Shared template | Stops on permission errors |
| `publish-template` | [`publish-template.md`](./publish-template.md) | Publish template to marketplace | Template ready to publish | Not for local templates | Standalone | Published template | Stops on validation errors |
| `presentation-coach` | [`presentation-coach.md`](./presentation-coach.md) | Coach for presentation improvement | PPTX exists | Not for new generation | Standalone | Coach report | Stops on no content |

---

## 3. New Workflows (2026-08-20)

### Short-term (P0)
| `md-to-pptx` | Quick MD→PPTX conversion | Markdown → PPTX |
| `content-optimize` | AI content optimization | Improved content |

### Mid-term (P1)
| `import-template` | External template import | Template library |
| `chart-generation` | Natural language chart gen | SVG charts |

### Long-term (P3)
| `team-collaboration` | Team template sharing | Shared templates |
| `publish-template` | Marketplace publish | Published templates |
| `presentation-coach` | Presentation coaching | Coach reports |
