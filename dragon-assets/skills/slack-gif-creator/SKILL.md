---
name: slack-gif-creator-slack-gif
version: 1.0.0
description: |
  用于创建针对 Slack 优化的动画 GIF 的知识和工具。提供约束、验证工具和动画概念。当用户请求为 Slack 创建动画 GIF 时（例如“为 Slack 制作一个 X 正在做 Y 的 GIF”）使用。
author: 天龙引擎团队
created: 2026-02-26
category: testing

triggers:
  - "用户提到「slack-gif-creator Slack GIF生成器」时"
---
