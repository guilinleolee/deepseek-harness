---
name: mcp-builder-mcp
version: 1.0.0
description: |
  创建高质量 MCP (Model Context Protocol) 服务端的指南，使 LLM 能够通过设计精良的工具与外部服务交互。在构建 MCP 服务端以集成外部 API 或服务时使用，无论使用 Python (FastMCP) 还是 Node/TypeScript (MCP SDK)。
author: 天龙引擎团队
created: 2026-02-26
category: ai

triggers:
  - "用户提到「mcp-builder MCP构建器」时"
---
