---
name: marketing-strategy-pmm-pmm
slash_commands: ["/gtm"]
description: 产品营销、定位、Go-to-Market (GTM) 策略和竞争情报。包含理想客户画像 (ICP) 定义、April Dunford 定位方法论、发布手册、竞争对手分析 (Battlecards) 和国际市场进入指南。适用于开发定位、规划 product launches、撰写营销信息、分析竞争对手、进入新市场或实现销售赋能。
github_url: https://github.com/anthropics/skills/tree/main/skills/marketing-strategy-pmm
...
triggers: ["marketing strategy pmm", "Marketing Strategy & Product Marketing"]
---
