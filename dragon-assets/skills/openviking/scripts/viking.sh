...
case "$CMD" in
    info)
        echo -e "${GREEN}═══════════════════════════════════════${NC}"
        echo -e "${GREEN}  OpenViking 状态 (天龙引擎 V8.17)    ${NC}"
        echo -e "${GREEN}═══════════════════════════════════════${NC}"
        echo "  配置: $OV_CONF"
        echo "  数据: $OV_DATA"
...
" 2>&1
    ...
    help|*)
        echo -e "${GREEN}═══════════════════════════════════════${NC}"
        echo -e "${GREEN}  OpenViking CLI (天龙引擎 V8.17)     ${NC}"
        echo -e "${GREEN}═══════════════════════════════════════${NC}"
        echo ""
        ...
        echo ""
        echo "天龙岗位调用:"
        echo "  [@记录师] 使用 OpenViking 索引文档"
        echo "  [@调研师] 在知识库中搜索相关内容"
        ;;
esac