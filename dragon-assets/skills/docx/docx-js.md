...
const doc = new Document({
  sections: [{
    properties: {
      page: {
        // ⚠️ CRITICAL: Always set page size explicitly - defaults to A4
        // Page sizes in DXA (twentieths of a point):
        // US Letter: 12,240 x 15,840 DXA (8.5" x 11")
        // A4: 11,906 x 16,838 DXA (210mm x 297mm) - DEFAULT
        size: { width: 12240, height: 15840 }, // US Letter
        // size: { width: 11906, height: 16838 }, // A4
        // For landscape: pass portrait dimensions and set orientation
