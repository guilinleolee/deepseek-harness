...
version: 1.0.0
description: |
  全面的文档创建、编辑和分析，支持修订追踪、批注、格式保留和文本提取。当 Claude 需要处理专业文档（.docx 文件）时使用，场景包括：(1) 创建新文档，(2) 修改或编辑内容，(3) 处理修订，(4) 添加批注，或其他任何文档相关任务。
author: 天龙引擎团队
created: 2026-02-26
...
When editing XML directly, use these entities for smart quotes:
