...
- Bash
- WebFetch
triggers: ["seo technical", "Technical SEO Audit"]
---
...
## Marketing SEO Audit Framework (from coreyhaines31/marketingskills)

### Priority-Based Optimization

| Priority | Timeframe | Tasks |
|----------|------------|-------|
| **P0 (Critical)** | Immediate | 404 errors, duplicate content, missing meta tags, broken internal links |
| **P1 (High)** | Within 1 week | Page speed, mobile experience, content quality, internal link structure |
| **P2 (Medium)** | Within 1 month | Content matrix, backlink building, brand signals |

### Technical SEO Checklist

| Check Item | Tool | Health Standard |
|------------|------|-----------------|
| Index status | Google Search Console | No error pages |
| Page speed | PageSpeed Insights | Score >90 |
| Mobile friendly | Mobile-Friendly Test | Pass |
| HTTPS | Browser | Valid certificate |
| sitemap.xml | GSC | Submitted and valid |
| robots.txt | Online checker | No misconfiguration |
| Structured data | Rich Results Test | No errors |
| Duplicate content | Screaming Frog | No duplicates |
