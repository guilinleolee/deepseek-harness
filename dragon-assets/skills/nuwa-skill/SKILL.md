...
license: MIT
source: https://github.com/alchaincyf/nuwa-skill (29.6k ⭐ · 蒸馏人 · 15+ 维度人物 skill)
upstream: name: alchaincyf/nuwa-skill
version: V3.x
...
triggers: ["nuwa skill", "天龙引擎镜像 · nuwa-skill V1.0（蒸馏人 · MIT）"]
---

# 天龙引擎镜像 · nuwa-skill V1.0（蒸馏人 · MIT）

> **上游**：alchaincyf/nuwa-skill · 29.6k ⭐ · MIT License
> **镜像模式**：tarball verbatim + 天龙扩展（AGENT.md / HANDOFF.md / PRODUCT.md / l3-specs/）
> **集成阶段**：天龙 35 阶段 · 周 1-A
> **协同链路**：nuwa → cangjie → darwin（与 cangjie AGPL 共有 test-prompts.json 协议）
