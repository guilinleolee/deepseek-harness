# 小红书高级图文视觉导演（天龙引擎本地镜像 V1.0.0 · 阶段 22）

> **📌 本地元信息**
> - 路径：`dragon-engine/skills/xhs-visual-director-skill/`
> - 来源：https://github.com/ziguishian/xhs-visual-director-skill（**1,065 ⭐** · **MIT**）
> - 镜像日期：2026-07-20 · 方法：`gh repo clone --depth 1` + `rm -rf .git`
> - 文件：24（19 源 + 3 cover assets + LICENSE + README + AGENTS + .gitignore）
> - upstream 内容**未修改**；本地增强写在 `l3-specs/`（与 upstream 物理隔离）
> - 合规：[ATTRIBUTION.md](ATTRIBUTION.md)（MIT ✅ 零红线）
> - 阶段 22 集成：[xhs-visual-director-integration.md](../../../../c--Users-li--claude/memory/xhs-visual-director-integration.md)
>
> **天龙引擎视角**：本 skill 是小红书图文**决策 / 规划上游**，下游接 3 个出图器：
> ```
> xhs-visual-director ─┬─→ gpt-image-2-style-library（21 模板 + 24 风格回灌）
>                       ├─→ baoyu-xhs-images（12 风格 × 8 版式 × 3 调色板）
>                       └─→ xhs-images（88 模板 + 12 AI 封面）
>                                       │
>                                       ▼
...
> 上游原文来自 https://github.com/ziguishian/xhs-visual-director-skill/blob/main/README.md（镜像于 2026-07-20），原文 License MIT，本地**未修改**。
...
## 欢迎交流
<p align="center">
  <img width="45%"  alt="wechat" src="https://github.com/user-attachments/assets/24c9a813-3041-4012-9641-4b9d76b45e14" />
  <img width="45%"  alt="wechat" src="https://github.com/user-attachments/assets/d05d9d30-2315-4a24-ae4d-2c80912c2f46" />
</p>
...
| 文件 | 用途 |
|---|---|
| [l3-specs/xhs-visual-director-to-image-gen.md](l3-specs/xhs-visual-director-to-image-gen.md) | L3 真集成桥接规范：visual-director 风格判断 → gpt-image-2 / baoyu-xhs-images / xhs-images |
| [l3-specs/style-24-to-gpt-image-2-mapping.md](l3-specs/style-24-to-gpt-image-2-mapping.md) | 24 风格 → gpt-image-2-style-library 21 模板 去重映射表 |
| [ATTRIBUTION.md](ATTRIBUTION.md) | MIT 合规与上游信息 |
