...
license: AGPL-3.0
source: https://github.com/kangarooking/cangjie-skill (6.2k ⭐ · 蒸馏书 · 7 阶段 RIA-TV++ 元流水线)
upstream: name: kangarooking/cangjie-skill
version: V1.x
...
packs: 21+（含 buffett-letters-skill · poor-charlies-almanack · mao-selected-works · huangdi-neijing 等）
modified: 2026-08-04
modified_by: 天龙引擎 dragon-engine
mirror_mode: AGPL mirror-only 严格（不可派生 · 不可 SaaS 闭源 · 修改源码必须开源）
triggers: ["cangjie skill", "天龙引擎镜像 · cangjie-skill V1.0（蒸馏书 · AGPL ⚠️）"]
---

# 天龙引擎镜像 · cangjie-skill V1.0（蒸馏书 · AGPL ⚠️）

> **上游**：[kangarooking/cangjie-skill](https://github.com/kangarooking/cangjie-skill) · 6,209 ⭐ · AGPL-3.0
> **镜像模式**：tarball verbatim + 天龙扩展（**不动** upstream 任何字节）
> **集成阶段**：天龙 35 · 周 2
> **协同链路**：cangjie → darwin（test-prompts.json 协议对齐）· cangjie ↔ book-distiller V9.12 互导
> **AGPL 红线**：严格 mirror-only + 商用边界 + 不可派生 + 派生必开源
