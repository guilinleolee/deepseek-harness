---
license: UNKNOWN
name: obsidian-markdown-obsidian
version: 1.0.0
description: |
  创建和编辑具有双链 (wikilinks)、嵌入、提醒框 (callouts)、属性和其他 Obsidian 特定语法的 Obsidian 风格 Markdown。在 Obsidian 中处理 .md 文件，或用户提到双链、提醒框、Frontmatter、标签或嵌入时使用。
author: 天龙引擎团队
created: 2026-02-26
category: testing

triggers:
  - "用户提到「obsidian-markdown Obsidian标记」时"
---
