...
license: MIT
source: https://github.com/alchaincyf/darwin-skill (5.3k ⭐ · skill 自动进化器 · 9 维 rubric + hill climbing)
upstream: name: alchaincyf/darwin-skill
version: V2.1
url: https://github.com/alchaincyf/darwin-skill
license: MIT
stars: 5321
arxiv: SkillLens 2605.23899 + SkillOpt 2605.23904
modified: 2026-08-04
modified_by: 天龙引擎 dragon-engine
mirror_mode: tarball + 天龙扩展（MIT 允许子包装）
triggers: ["darwin skill", "Darwin Skill 2.0"]
---
