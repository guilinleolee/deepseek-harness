...
name: 35-04内容运营 内容运营
description: |
  多平台发布、内容分发、发布数据分析。支持TikTok/抖音短视频发布。整合自十八子写作系统的发布自动化功能。
  用于 Codex 环境，承担天龙引擎 内容运营 角色（营销 类）。
  触发: @内容运营
version: 1.1.0
category: dragon-engine-role-营销
author: 天龙引擎团队
source: dragon-engine/35-04-content-operator.md
created: 2026-06-15
---
...
> **分类**: 营销
> **原文件**: `agents/35-04-content-operator.md`
