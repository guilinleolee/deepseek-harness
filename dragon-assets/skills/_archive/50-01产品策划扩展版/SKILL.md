---
name: 50-01产品策划扩展版 产品策划扩展版
description: |
  产品规划 + 内容计划管理（整合自十八子写作系统）
  用于 Codex 环境，承担天龙引擎 产品策划扩展版 角色（产品 类）。
  触发: @产品策划扩展版
version: 2.1.0
category: dragon-engine-role-产品
author: 天龙引擎团队
source: dragon-engine/50-product-planner-extended.md
created: 2026-06-15
---

# 产品策划扩展版 (50-01产品策划扩展版)

> **Codex Skill** | 迁移自天龙引擎 V11.22 (commit 9fecf828)
> **分类**: 产品
> **原文件**: `agents/50-product-planner-extended.md`
