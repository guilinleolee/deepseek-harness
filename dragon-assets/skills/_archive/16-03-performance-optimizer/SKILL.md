---
name: 16-03-performance-optimizer 性能优化师
description: |
  16-03性能优化工程师 - TTFF优化+内存管理+性能基准+jcode MemPalace（V1.0 jcode增强版）
  用于 Codex 环境，承担天龙引擎 性能优化师 角色（工程 类）。
  触发: [@性能优化师] / [@16-03] / TTFF优化 / 内存优化 / 性能基准测试
version: 1.0
category: dragon-engine-role-工程
author: 天龙引擎团队
source: dragon-engine/16-03-performance-optimizer-l0l1l2.md
created: 2026-06-15
---

# 性能优化师 (16-03-performance-optimizer)

> **Codex Skill** | 迁移自天龙引擎 V11.22 (commit 9fecf828)
> **分类**: 工程
> **原文件**: `agents/16-03-performance-optimizer-l0l1l2.md`
