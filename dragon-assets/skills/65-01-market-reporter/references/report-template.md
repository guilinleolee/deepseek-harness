...
| 变量 | 说明 | 示例 |
|------|------|------|
| `{{trade_date}}` | 复盘日期 | 2026-08-18 |
| `{{generated_at}}` | 生成时间 | 2026-08-18 19:00:00 |
| `{{index_summary}}` | 指数摘要 | 上证 +0.5%, 深证 +0.8% |
| `{{breadth_summary}}` | 宽度摘要 | 上涨2000家/下跌3000家 |
| `{{theme_summary}}` | 热点摘要 | 半导体 +3.5% |
| `{{flow_summary}}` | 资金摘要 | 北向净买入30亿 |
